...
export const CHANGE_ASSIGNMENT_CATEGORY_UPDATE_MSG_OPACITY = 'CHANGE_ASSIGNMENT_CATEGORY_UPDATE_MSG_OPACITY';
export const CHANGE_CATEGORY_WAIT_TO_UPDATE = 'CHANGE_CATEGORY_WAIT_TO_UPDATE';
...
export const FETCH_BUG_REVIEW_QUERY_DATA = 'FETCH_BUG_REVIEW_QUERY_DATA';
export const FETCH_BUG_REVIEW_ADD_OPTIONS_SUCCESS = 'FETCH_BUG_REVIEW_ADD_OPTIONS_SUCCESS';


//Bug Report page actions
export const FETCH_BUG_REPORT_ROOT_CAUSE_SUCCESS = 'FETCH_BUG_REPORT_ROOT_CAUSE_SUCCESS';
export const FETCH_BUG_REPORT_TAGS_SUCCESS = 'FETCH_BUG_REPORT_TAGS_SUCCESS';
export const FETCH_BUG_REPORT_OWNER_SUCCESS = 'FETCH_BUG_REPORT_OWNER_SUCCESS';
export const SET_BUG_REPORT_PROJECT_VERSION = 'SET_BUG_REPORT_PROJECT_VERSION';
