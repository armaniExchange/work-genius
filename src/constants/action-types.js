...
export const FETCH_PTO_APPLICATION_REQUEST = 'FETCH_PTO_APPLICATION_REQUEST';
export const FETCH_PTO_APPLICATION_SUCCESS = 'FETCH_PTO_APPLICATION_SUCCESS';
export const CREATE_PTO_APPLICATION_REQUEST = 'CREATE_PTO_APPLICATION_REQUEST';
export const CREATE_PTO_APPLICATION_SUCCESS = 'CREATE_PTO_APPLICATION_SUCCESS';
export const DELETE_PTO_APPLICATION_REQUEST = 'DELETE_PTO_APPLICATION_REQUEST';
export const DELETE_PTO_APPLICATION_SUCCESS = 'DELETE_PTO_APPLICATION_SUCCESS';
export const UPDATE_PTO_APPLICATION_REQUEST = 'UPDATE_PTO_APPLICATION_REQUEST';
export const UPDATE_PTO_APPLICATION_SUCCESS = 'UPDATE_PTO_APPLICATION_SUCCESS';