...
export const SET_PTO_APPLY_MODAL_STATE_ = 'SET_PTO_APPLY_MODAL_STATE_';
export const FILTER_PTO_TABLE_ = 'FILTER_PTO_TABLE_';
export const SORT_PTO_TABLE_BY_CATEGORY_ = 'SORT_PTO_TABLE_BY_CATEGORY_';
export const FETCH_PTO_APPLICATION_SUCCESS_ = 'FETCH_PTO_APPLICATION_SUCCESS_';
export const FETCH_USERS_WITH_PTO_SUCCESS_ = 'FETCH_USERS_WITH_PTO_SUCCESS_';
export const RESET_PTO_TABLE_ = 'RESET_PTO_TABLE_';
export const DECREASE_YEAR_ = 'DECREASE_YEAR_';
export const INCREASE_YEAR_ = 'INCREASE_YEAR_';

export const FETCH_BUG_REVIEW_APPLICATION_SUCCESS = 'FETCH_BUG_REVIEW_APPLICATION_SUCCESS';
export const FETCH_BUG_REVIEW_CHANGE_RESOLVE_REASON_TYPE = 'FETCH_BUG_REVIEW_CHANGE_RESOLVE_REASON_TYPE';
